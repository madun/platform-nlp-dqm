 ...
 * Comprehensive list of Indonesian stopwords for NLP processing
...
export const indonesianStopwords = new Set([
  ...
  'balik', 'banyak', 'banyaknya', 'bapak', 'baru', 'bawah', 'beberapa',
  ...
  'ketika', 'khususnya', 'kini', 'kinilah', 'kira', 'kira-kira', 'kiranya',
  'kita', 'kitalah', 'kok', 'kurang', 'lagi', 'lagian', 'lah', 'lain',
  'lainnya', 'lalu', 'lama', 'lamanya', 'lanjut', 'lanjutnya', 'lebih',
  'lewat', 'lihat', 'luar', 'lagi', 'maka', 'makanya', 'makin', 'malah',
  ...
  'pentingnya', 'per', 'percuma', 'pergi', 'perkara', 'perlu', 'perlukah',
  'perlunya', 'pernah', 'persoalan', 'pertama', 'pertama-tama', 'pertanyaan',
  'pertanyakan', 'pihak', 'pihaknya', 'pukul', 'pula', 'pun', 'punya',
  'rasa', 'rasanya', 'rata', 'rupanya', 'saat', 'saatnya', 'saja', 'sajalah',
  'saling', 'sama', 'sama-sama', 'sambil', 'sampai', 'sampai-sampai',
  'sampaikan', 'sana', 'sangat', 'sangatlah', 'saya', 'sayalah', 'se',
  ...
  'sekadar', 'sekadarnya', 'sekali', 'sekali-kali', 'sekalian', 'sekaligus',
  'sekalipun', 'sekarang', 'sekarang', 'sekecil', 'seketika', 'sekiranya',
  ...
  'semula', 'sen', 'sendiri', 'sendirian', 'sendirinya', 'seolah', 'seolah-olah',
  ...
  'tak', 'tambah', 'tambahnya', 'tampak', 'tampaknya', 'tandas', 'tandasnya',
  'tanpa', 'tanya', 'tanyakan', 'tanyanya', 'tapi', 'tegas', 'tegasnya',
  'telah', 'tempat', 'tengah', 'tentang', 'tentu', 'tentulah', 'tentunya',
  ...
  'tertentu', 'tertuju', 'terus', 'terutama', 'tetap', 'tetapi', 'tiap',
  'tiba', 'tiba-tiba', 'tidak', 'tidakkah', 'tidaklah', 'tiga', 'tinggi',
...
export function removeStopwords(tokens: string[]): string[] {
  return tokens.filter(token => !indonesianStopwords.has(token.toLowerCase()));
}
...
export function isStopword(word: string): boolean {
  return indonesianStopwords.has(word.toLowerCase());
}
